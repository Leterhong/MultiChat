...
const { readPackageVersion, safeId, normalizePackage } = require('./catalog');
...
// 插件 / 技能 / 智能体 / 运行 相关常量（原 server.js 顶层常量集中于此）
const PLUGIN_DIR = path.join(__dirname, '..', 'plugins');
const PLUGIN_STATE = 'plugins_state.json';
const SKILL_FILE = 'skills.json';
const AGENT_FILE = 'agents.json';
const RUN_FILE = 'runs.json';
const MAX_RUNS = 200;
const ALLOW_REMOTE_MCP = process.env.MULTICHAT_ALLOW_REMOTE_MCP === '1';
