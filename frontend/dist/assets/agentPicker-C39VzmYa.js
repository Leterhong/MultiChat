import{d as e,f as t,h as n,p as r,u as i}from"./index-CASVCOUO.js";r(`#workspacePicker`).onclick=()=>{let t=e.workspaces.map(e=>({id:e.id,name:e.name,description:e.description}));if(!t.length){openSettings(`workspace`);return}showModal({title:`选择工作区`,body:`<div class="picker-dialog-intro"><span>切换对话与项目所在的工作区</span><span>${t.length} 个工作区</span></div>
